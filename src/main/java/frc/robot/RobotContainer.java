...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
   ...
   // Example of how to use the onboard IO
    ...
    Autons.addOption("CloseArm",new CloseClaw());
    Autons.addOption("OpenArm", new OpenClaw());
   
    SmartDashboard.putData("CloseArm",new CloseClaw());
    SmartDashboard.putData("OpenArm", new OpenClaw());
    ...
    SmartDashboard.putNumber("Gripper Pos", RobotContainer.claw.get_armPos());
    SmartDashboard.putNumber("Gripper Angle", RobotContainer.claw.getArmAngle());
